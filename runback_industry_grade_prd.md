...
An Artifact is any output worth preserving and inspecting.
...
type Artifact = {
  ...
  runId: string;
  nodeId?: string;
  type: "log" | "diff" | "file" | "transcript" | "json" | "markdown" | "screenshot" | "patch";
  path?: string;
...
9. Basic artifact storage.
10. Git/workspace checkpointing.
11. Rule-based recovery policy classifier.
12. Failed node detection.
13. Replay recommendation.
14. Semi-automatic replay that restores checkpoint and relaunches Claude Code.
15. Replay branch visualization.
